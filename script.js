...
<span class="fn">print</span>(<span class="fn">спечели_турнира</span>())`,
    ...
    en: {
        ...
        gr_rule_8: "“The eye of the bystander”: When two people work on one mechanism for a long time, they stop seeing their mistakes. In MEHANO we have a rule: “You look at it”. A third person always checks the assembly or the code with “fresh eyes” to find oversights that others missed from fatigue.",
        ...
        gr_rule_21: "“Laughter is the shortest distance between two ideas”: When we get stuck on a problem, we stop and joke. Our most genius solutions were born exactly between two jokes. In MEHANO, humor is not a distraction, but a tool for innovation.",
        gr_rule_22: "“The law of the tenth of a millimeter”: If the regulations say the robot must be in base, we use every millimeter to the line itself. Our trick is not to cross the line, but to step on it so that only one photon of light doesn't pass under our tire. Being a hair from a foul is an art that wins valuable space.",
        gr_rule_23: "“The law of 'Just Started'”: The machine always works perfectly when no one is watching. As soon as the mentor, the judge, or the captain comes – it decides to take a break. In MEHANO, we test “undercover” so the hardware doesn't realize it's being watched.",
        gr_rule_24: "“If it works – don't touch it!”: If the system has nailed the perfect result 5 minutes before the start – forget about “one more small adjustment”. The biggest catastrophes in MEHANO history start with the phrase: “Wait, let me just fix this”. At that moment, your hands should be in your pockets, not on the machine.",
        gr_rule_25: "“Scattered like LEGO, assembled like a scalpel”: In MEHANO, order on the desk is a myth – we live and create among mountains of cables, sensors, and scattered bricks from past missions. An orderly workplace puts the brain to sleep, but our disorder keeps it awake. Our best innovations are born exactly then – while digging for a lost LEGO gear among the boards and cables.",
        gr_rule_26: "If you have only one of something, it will break. If you have five, you will never need them. In MEHANO we believe in “over-insurance” – always carry a spare motor, spare cable, and spare battery, even if you think you're just going for a walk.",
        gr_rule_27: "“The MEHANO shirt effect”: When you put on the team shirt, you stop being just a student and become part of a legend. The responsibility is to those before you and to those after you. On the field, we behave so that even the competition wants to be like us.",
        gr_rule_28: "We don't read the rules just to find out what is allowed, but to discover what is not forbidden. If the mission description doesn't explicitly say we can't use a rubber band or gravity in a certain way – then that is our secret loophole. We call it “regulation optimization”.",
        gr_rule_29: "“The law of the clean track”: When we see another team crossing the line of what's allowed, we don't get angry – we get ambitious. Our trick is to be so precise that even by following every point of the regulations, we achieve a higher result than those who “cut corners”. Honesty always breaks through, because at the finish, the jury looks for character, not just points won by cheating.",
        gr_rule_30: "“After the competition – we eat again”: Regardless of the result, the team goes to celebrate. Victories are shared, but friendship is what remains after we put the robot back in the box.",
...
<span class="fn">print</span>(<span class="fn">win_tournament</span>())`,
    ...
    el: {
        ...
        gr_rule_2: "Ποτέ δεν ξεκινάμε το ρομπότ σε κλίση. Η σταθερή επιφάνεια τη στιγμή της εκκίνησης είναι κρίσιμη για τη λειτουργία των αισθητήρων.",
        gr_rule_3: "Μηχανική αντοχή: Κάθε κατασκευή πρέπει να είναι όσο το δυνατόν πιο γερή. Δεν επιτρέπουμε περιστρεφόμενα γρανάζια, χαλαρά μέρη ή ασυνήθιστους θορύβους – ο ήχος του ρομπότ είναι δείκτης της υγείας του.",
        ...
        gr_rule_5: "Το υλικό (hardware) και το λογισμικό (software) δεν είναι ξεχωριστά μέρη – πρέπει πάντα να βοηθούν το ένα το άλλο και να λειτουργούν σε πλήρη συγχρονισμό.",
        gr_rule_6: "Πειραματική προσέγγιση: Κάθε ιδέα, όσο ασυνήθιστη κι αν είναι, πρέπει να δοκιμάζεται στην πράξη. Η εμπειρία είναι ο καλύτερος δάσκαλος.",
        gr_rule_7: "Αν κάτι πάει στραβά ή μια αποστολή δεν ολοκληρωθεί – φταίει πάντα το «ρομπότ». Στηρίζουμε ο ένας τον άλλον και δεν αναζητούμε ευθύνες στα μέλη της ομάδας!",
        gr_rule_8: "«Το μάτι του τρίτου»: Όταν δύο άτομα εργάζονται σε έναν μηχανισμό για μεγάλο χρονικό διάστημα, σταματούν να βλέπουν τα λάθη τους. Στη MEHANO έχουμε έναν κανόνα: «Κοίταξέ το εσύ». Ένα τρίτο άτομο ελέγχει πάντα τη συναρμολόγηση ή τον κώδικα με «φρέσκια ματιά».",
        gr_rule_9: "Πριν από κάθε διαγωνιστική διαδρομή, τα ελαστικά καθαρίζονται. Η σκόνη είναι ο μόνος λόγος που το ρομπότ «ξεγελάει» το γυροσκόπιο κατά τη διάρκεια μιας στροφής.",
        ...
        gr_rule_11: "Γρήγορη αλλαγή, ήρεμο μυαλό: Οι αλλαγές εξασκούνται «στα τυφλά» μέχρι να γίνουν αυτόματες κινήσεις. Στο τραπέζι δεν σκέφτεσαι «πώς μπαίνει αυτό», απλά ενεργείς.",
        ...
        gr_rule_13: "Όταν κάποιος λέει «ΣΤΟΠ, υπάρχει πρόβλημα», όλη η ομάδα σταματά και ακούει. Τα μικρά λάθη που κάποιος πρόσεξε εγκαίρως σώζουν μεγάλους διαγωνισμούς.",
        gr_rule_14: "Όποτε είναι δυνατόν, κατανέμετε το βάρος των εξαρτημάτων συμμετρικά. Ένα ρομπότ που είναι βαρύ από τη μία πλευρά αρχίζει πάντα να «ντριφτάρει».",
        gr_rule_15: "Το ρομπότ κατασκευάζεται έτσι ώστε να μπορείτε να αλλάξετε την μπαταρία ή να συνδέσετε το καλώδιο φόρτισης χωρίς να το αποσυναρμολογήσετε μέχρι τη μέση.",
        gr_rule_16: "Κάθε τμήμα ή γραμμή κώδικα πρέπει να έχει μια εξήγηση. Σε μια εβδομάδα, δεν θα θυμάστε γιατί βάλατε ακριβώς αυτή τη στροφή 42 μοιρών.",
        gr_rule_17: "«Αν υπάρχουν προβλήματα, τότε είμαστε στο σωστό δρόμο»: Τα προβλήματα δεν είναι εμπόδια, αλλά σκαλοπάτια.",
        gr_rule_18: "«Η καλύτερη λύση είναι η απλούστερη»: Αν ένα εξάρτημα είναι πολύ περίπλοκο και σπάει συχνά, σημαίνει ότι πρέπει να το απλοποιήσουμε.",
        gr_rule_19: "Κοντά στον υπολογιστή με τον κώδικα δεν υπάρχουν χυμοί ή λιπαρά σνακ. Ένας χυμός που χύθηκε μπορεί να τερματίσει τη σεζόν πιο γρήγορα από οποιοδήποτε σφάλμα λογισμικού.",
        gr_rule_20: "«Το ρομπότ είναι μέλος της οικογένειας»: Του απευθυνόμαστε με το όνομά του. Όταν φροντίζεις τον εξοπλισμό, σε ανταμείβει με ακρίβεια στο γήπεδο.",
        gr_rule_21: "«Το γέλιο είναι η μικρότερη απόσταση ανάμεσα σε δύο ιδέες»: Όταν κολλάμε σε ένα πρόβλημα, σταματάμε και αστειευόμαστε. Στη MEHANO, το χιούμορ είναι εργαλείο καινοτομίας.",
        gr_rule_22: "«Ο νόμος του δέκατου του χιλιοστού»: Αν οι κανονισμοί λένε ότι το ρομπότ πρέπει να είναι στη βάση, χρησιμοποιούμε κάθε χιλιοστό μέχρι την ίδια τη γραμμή.",
        gr_rule_23: "«Ο νόμος του 'Μόλις Ξεκίνησε'»: Η μηχανή λειτουργεί πάντα τέλεια όταν κανείς δεν κοιτάζει. Μόλις έρθει ο μέντορας ή ο κριτής – αποφασίζει να κάνει διάλειμμα.",
        gr_rule_24: "«Αν δουλεύει – μην το αγγίζεις!»: Αν το σύστημα έχει πετύχει το τέλειο αποτέλεσμα 5 λεπτά πριν την έναρξη – ξεχάστε τις «μικρορυθμίσεις».",
        gr_rule_25: "«Διασκορπισμένοι σαν LEGO, ενωμένοι σαν νυστέρι»: Στη MEHANO, η τάξη στο γραφείο είναι μύθος – δημιουργούμε μέσα σε βουνά από καλώδια και αισθητήρες.",
        gr_rule_26: "Αν έχεις μόνο ένα από κάτι, θα σπάσει. Αν έχεις πέντε, δεν θα τα χρειαστείς ποτέ. Πάντα να έχετε μαζί σας εφεδρικό μοτέρ, καλώδιο και μπαταρία.",
        gr_rule_27: "«Το φαινόμενο της φανέλας MEHANO»: Όταν φοράς τη μπλούζα της ομάδας, γίνεσαι μέρος ενός θρύλου. Η ευθύνη είναι προς αυτούς που προηγήθηκαν και αυτούς που θα ακολουθήσουν.",
        gr_rule_28: "Δεν διαβάζουμε τους κανόνες μόνο για να δούμε τι επιτρέπεται, αλλά για να ανακαλύψουμε τι ΔΕΝ απαγορεύεται. Αυτό το ονομάζουμε «βελτιστοποίηση κανονισμών».",
        gr_rule_29: "«Ο νόμος της καθαρής διαδρομής»: Όταν βλέπουμε μια άλλη ομάδα να ξεπερνά τα όρια, δεν θυμώνουμε – γινόμαστε πιο φιλόδοξοι. Η ειλικρίνεια πάντα κερδίζει στο τέλος.",
        gr_rule_30: "«Μετά τον διαγωνισμό – τρώμε ξανά»: Ανεξάρτητα από το αποτέλεσμα, η ομάδα πάει να γιορτάσει. Οι νίκες μοιράζονται, αλλά η φιλία μένει.",
        ...
        gr_rule_1: "Το ρομπότ έχει πάντα μια αυστηρά καθορισμένη θέση εκκίνησης. Πρέπει να σχηματίζει μια ακριβή γωνία με ένα συγκεκριμένο τετράγωνο στη βάση για να διασφαλιστεί η σωστή τροχιά.",
        gr_rule_2: "Ποτέ μην ξεκινάτε το ρομπότ σε κλίση. Η σταθερή επιφάνεια κατά τη στιγμή της εκκίνησης είναι κρίσιμη για την απόδοση των αισθητήρων.",
        gr_rule_3: "Μηχανική Ακεραιότητα: Κάθε κατασκευή πρέπει να είναι όσο το δυνατόν πιο ισχυρή. Δεν επιτρέπουμε ολίσθηση γραναζιών, χαλαρά μέρη ή ασυνήθιστους θορύβους – ο ήχος του ρομπότ είναι ένδειξη της υγείας του.",
        gr_rule_4: "Ο σχεδιασμός του ρομπότ πρέπει να είναι πυκνός και ειδικά βελτιστοποιημένος για τις μοναδικές προκλήσεις του τρέχοντος διαγωνισμού.",
        gr_rule_5: "Το υλικό και το λογισμικό δεν είναι χωριστές οντότητες – πρέπει πάντα να υποστηρίζουν το ένα το άλλο και να λειτουργούν σε πλήρη συγχρονισμό.",
        gr_rule_6: "Πειραματική Προσέγγιση: Κάθε ιδέα, όσο αντισυμβατική και αν είναι, πρέπει να δοκιμάζεται στην πράξη. Η εμπειρία είναι ο καλύτερος δάσκαλος.",
        gr_rule_7: "Αν κάτι πάει στραβά ή μια αποστολή αποτύχει – το «ρομπότ» φταίει πάντα. Στηρίζουμε ο ένας τον άλλον και δεν αναζητούμε ευθύνες μέσα στην ομάδα!",
        gr_rule_8: "«Το Μάτι του Πλάγιου Παρατηρητή»: Όταν δύο άτομα εργάζονται σε έναν μηχανισμό για μεγάλο χρονικό διάστημα, σταματούν να βλέπουν τα λάθη τους. Ένα τρίτο άτομο ελέγχει πάντα την κατασκευή ή τον κώδικα με «φρέσκια ματιά».",
        gr_rule_9: "Πριν από κάθε αγωνιστική εκτέλεση, τα ελαστικά καθαρίζονται. Η σκόνη είναι ο μόνος λόγος που το ρομπότ «ξεγελάει» το γυροσκόπιο κατά τη διάρκεια μιας στροφής.",
        gr_rule_10: "Μετά από κάθε επιστροφή στη βάση, ελέγξτε αν οι μαύροι και μπλε πείροι έχουν εισαχθεί πλήρως. Οι κραδασμοί του ρομπότ συχνά τους χαλαρώνουν.",
        gr_rule_11: "Γρήγορη Αλλαγή, Ήρεμο Μυαλό: Οι στάσεις στα πιτ εξασκούνται μέχρι να γίνουν αυτόματες. Στο τραπέζι, δεν σκέφτεσαι «πώς ταιριάζει αυτό» – απλά ενεργείς.",
        gr_rule_12: "Παρακολουθούμε πάντα τι κάνουν οι άλλοι για να βελτιωθούμε, αλλά σεβόμαστε τη δουλειά τους και αναζητούμε τις δικές μας μοναδικές λύσεις.",
        gr_rule_13: "Όταν κάποιος λέει «STOP, υπάρχει πρόβλημα», όλη η ομάδα σταματά και ακούει. Μικρά λάθη που εντοπίζονται εγκαίρως σώζουν μεγάλους διαγωνισμούς.",
        gr_rule_14: "Όποτε είναι δυνατόν, κατανέμετε το βάρος των εξαρτημάτων συμμετρικά. Ένα ρομπότ που είναι βαρύ από τη μία πλευρά θα αρχίζει πάντα να «γλιστράει».",
        ...
        gr_rule_16: "Κάθε μπλοκ ή γραμμή κώδικα πρέπει να έχει μια εξήγηση. Σε μια εβδομάδα, δεν θα θυμάστε γιατί βάλατε ακριβώς αυτή τη στροφή 42 μοιρών.",
        gr_rule_17: "«Αν υπάρχουν προβλήματα, είμαστε στον σωστό δρόμο»: Τα προβλήματα δεν είναι εμπόδια, αλλά βήματα. Κάθε λυμένο πρόβλημα κάνει το ρομπότ πιο έξυπνο και εμάς καλύτερους μηχανικούς.",
        gr_rule_18: "«Η καλύτερη λύση είναι η απλούστερη»: Εάν ένα εξάρτημα είναι πολύ περίπλοκο και σπάει συχνά, πρέπει να το απλοποιήσουμε. Η πολυπλοκότητα είναι εχθρός της αξιοπιστίας.",
        gr_rule_19: "Όχι χυμοί ή λιπαρά αρτοσκευάσματα κοντά στον υπολογιστή κωδικοποίησης. Ένα χυμένο ποτό μπορεί να τερματίσει τη σεζόν γρηγορότερα από οποιοδήποτε σφάλμα λογισμικού.",
        gr_rule_20: "«Το ρομπότ είναι μέλος της οικογένειας»: Το προσφωνούμε με το όνομά του. Όταν φροντίζεις την τεχνολογία, σου το ανταποδίδει με ακρίβεια στο γήπεδο.",
        gr_rule_21: "«Το γέλιο είναι η συντομότερη απόσταση μεταξύ δύο ιδεών»: Όταν κολλάμε σε ένα πρόβλημα, σταματάμε και αστειευόμαστε. Οι πιο ευφυείς λύσεις μας γεννιούνται συχνά ανάμεσα σε δύο αστεία.",
        gr_rule_22: "«Ο Νόμος του Δέκατου του Χιλιοστού»: Εάν οι κανόνες λένε ότι το ρομπότ πρέπει να βρίσκεται στη βάση, χρησιμοποιούμε κάθε χιλιοστό μέχρι τη γραμμή. Το κόλπο μας είναι να πατάμε πάνω της.",
        gr_rule_23: "«Ο Νόμος του 'Μόλις Δούλεψε'»: Το μηχάνημα λειτουργεί πάντα τέλεια όταν κανείς δεν κοιτάζει. Μόλις φτάσει ο μέντορας ή ο κριτής, αποφασίζει να κάνει ένα διάλειμμα.",
        gr_rule_24: "«Αν δουλεύει – μην το αγγίζετε!»: Εάν το σύστημα πέτυχε τέλειο σκορ 5 λεπτά πριν την έναρξη – ξεχάστε «άλλη μια μικρή ρύθμιση». Οι μεγαλύτερες καταστροφές ξεκινούν με τη φράση: «Περίμενε, άσε με να το φτιάξω αυτό».",
        gr_rule_25: "«Διασκορπισμένα σαν LEGO, Συναρμολογημένα σαν Νυστέρι»: Στη MEHANO, ένα τακτοποιημένο γραφείο είναι μύθος – το χάος μας κρατά τον εγκέφαλο σε εγρήγορση. Οι καλύτερες καινοτομίες μας γεννιούνται ενώ σκάβουμε για ένα χαμένο γρανάζι.",
        gr_rule_26: "Εάν έχετε μόνο ένα από κάτι, θα σπάσει. Εάν έχετε πέντε, δεν θα τα χρειαστείτε ποτέ. Να έχετε πάντα μαζί σας εφεδρικό κινητήρα, καλώδιο και μπαταρία.",
        gr_rule_27: "«Το Φαινόμενο της Μπλούζας MEHANO»: Όταν φοράτε τη φανέλα της ομάδας, παύετε να είστε απλά μαθητής και γίνεστε μέρος ενός θρύλου. Ευθύνη απέναντι σε αυτούς που προηγήθηκαν και σε αυτούς που έπονται.",
        gr_rule_28: "Δεν διαβάζουμε τους κανόνες μόνο για να δούμε τι επιτρέπεται, αλλα για να βρούμε τι δεν απαγορεύεται. Αν δεν απαγορεύεται ρητά, είναι το μυστικό μας παραθυράκι. Το ονομάζουμε «Βελτιστοποίηση Κανόνων».",
        gr_rule_29: "«Ο Νόμος του Καθαρού Ίχνους»: Όταν βλέπουμε μια άλλη ομάδα να ξεπερνά τα όρια, δεν θυμώνουμε – γινόμαστε φιλόδοξοι. Η ειλικρίνεια επικρατεί γιατί η κριτική επιτροπή αναζητά χαρακτήρα.",
        gr_rule_30: "«Μετά τον διαγωνισμό – τρώμε ξανά»: Ανεξάρτητα από το αποτέλεσμα, η ομάδα πάει να γιορτάσει. Οι νίκες μοιράζονται, αλλά η φιλία παραμένει.",
...
<span class="fn">print</span>(<span class="fn">win_tournament</span>())`,
    ...
    zh: {
        ...
        gr_rule_2: "切勿在斜坡上启动机器人。启动时刻的稳定表面对传感器的运行至关重要。",
        gr_rule_3: "工程强度：每个结构都必须尽可能牢固。我们不允许齿轮空转、零件松动或出现异常噪音——机器人的声音是其健康状况的指标。",
        gr_rule_4: "机器人的设计必须紧凑，并针对当前比赛的具体挑战进行专门优化。",
        gr_rule_5: "硬件和软件不是独立的部分——它们必须始终相互配合并保持完全同步。",
        gr_rule_6: "实验方法：任何想法，无论多么非传统，都必须在实践中进行测试。经验是最好的老师。",
        gr_rule_7: "如果出了问题或任务未能完成——那永远是“机器人”的错。我们相互支持，不指责团队成员！",
        gr_rule_8: "“旁观者之眼”：当两个人长时间研究同一个机制时，他们会停止发现自己的错误。在 MEHANO，我们有一个规则：“你来看看”。第三个人总是用“新鲜的眼光”检查组装或代码。",
        gr_rule_9: "在每次比赛运行前，都要清洁轮胎。灰尘是机器人转向时陀螺仪产生误差的唯一原因。",
        gr_rule_10: "每次返回基地后，检查黑色和蓝色插销是否完全插入。机器人的振动经常会使它们松动。",
        gr_rule_11: "快速更换，冷静头脑：更换动作要进行“旱地”训练，直到成为自动动作。在赛场上不要思考“怎么放”，直接行动。",
        gr_rule_12: "我们始终观察他人的做法以变得更好，但我们尊重他们的劳动，并寻求我们自己独特的解决方案。",
        gr_rule_13: "当有人说“停，有问题”时，整个团队都会停下来倾听。及时发现的小错误能挽救大型比赛。",
        gr_rule_14: "尽可能对称地分配附件的重量。重心偏向一侧的机器人总是会产生“漂移”（自行转向）。",
        gr_rule_15: "机器人的结构设计应便于更换电池或插入充电线，而无需拆卸一半部件。",
        gr_rule_16: "每个代码块或每行代码都必须有解释。一周后，你不会记得为什么设置了那个精确的 42 度转弯。",
        gr_rule_17: "“如果有问题，说明我们在正确的道路上”：问题不是障碍，而是阶梯。每个解决的问题都让机器人更聪明，让我们成为更好的工程师。",
        gr_rule_18: "“最好的解决方案是最简单的”：如果一个附件太复杂且经常损坏，这意味着我们需要简化它Messagem-id 复杂性是可靠性的敌人。",
        gr_rule_19: "代码电脑附近严禁放置果汁或油腻零食。洒掉的果汁可能比任何软件错误都能更快地结束赛季。",
        gr_rule_20: "“机器人是家庭成员”：我们直呼其名（或至少保持尊重）。当你照顾好设备时，它会在赛场上以精确度回报你。",
        gr_rule_21: "“笑声是两个想法之间最短的距离”：当我们陷入困境时，我们会停下来开玩笑 Messagem-id 在 MEHANO，幽默不是分心，而是创新的工具。",
        gr_rule_22: "“十分之一毫米定律”：如果规则规定机器人必须在基地内，我们会利用到线本身的每一毫米。保持在违规边缘是一门赢得宝贵空间的艺术。",
        gr_rule_23: "“‘刚启动’定律”：当没人看时，机器总是运行得非常完美。一旦导师或裁判走过来——它就决定休息一下。",
        gr_rule_24: "“如果它运行正常——就不要碰它！”：如果系统在赛前 5 分钟达到了完美结果——忘掉“再做一点小调整”吧。",
        gr_rule_25: "“散如乐高，聚如手术刀”：在 MEHANO，桌子整洁是神话——我们在堆积如山的电缆和传感器中创作。这种混乱让大脑保持清醒。",
        gr_rule_26: "如果你只有一件东西，它就会坏掉。如果你有五件，你永远不会需要它们。永远携带备用电机、电缆和电池。",
        gr_rule_27: "“MEHANO 队服效应”：当你穿上队服时，你就不再只是一个学生，而是成为了传奇的一部分。要在赛场上表现得让对手都想效仿我们。",
        gr_rule_28: "我们读规则不仅是为了了解什么是允许的，还要发现什么是没被禁止的。我们称之为“规则优化”。",
        gr_rule_29: "“洁净轨迹定律”：当我们看到另一支队伍越线时，我们不生气——我们变得更有斗志。诚实总是能开辟道路，因为最后评委看重的是品质。",
        gr_rule_30: "“比赛结束后——还要再吃一顿”：无论结果如何，团队都会去庆祝。胜利是共享的，但友谊是持久的。",
