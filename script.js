...
<span class="fn">print</span>(<span class="fn">спечели_турнира</span>())`,
    ...
    en: {
        ...
        hero_sub: "A young FIRST LEGO League team of engineers, thinkers and dreamers. We build robots, solve problems and leave a mark.",
        ...
        models_title: "3D Robot Archive", models_desc: "Select a model from the list to explore our robot development.",
        models_loading: "LOADING...", models_main: "Main Robot", models_run: "Mission: Run",
        brief_models_desc: "Explore our robotic designs in detailed 3D format. See every part up close.",
        btn_reset: "RESET", btn_auto_rotate: "AUTO-ROTATE",
        about_label: "About Us", about_title: "Who We Are",
        about_desc: "A team of seven youths united by a passion for engineering and innovation.",
        ...
        about_project_title: "Innovative Project",
        about_project_desc: "We solve real-world problems with engineering ideas inspired by the season theme.",
        about_video: "Video",
        about_values_title: "Core Values",
        about_values_desc: "Respect, openness, impact, inclusion, teamwork and fun.",
        code_label: "Code", code_title: "Programming",
        project_label: "Project", project_title: "Innovative Project",
        project_name: "ASOA 2.0 - Automated Desalination System",
        project_desc: "A solution that makes the world a better place through technology and IoT monitoring.",
        project_problem_label: "Problem",
        project_problem: "Archaeological finds from the sea are rapidly destroyed by salt crystals if not properly desalinated.",
        project_solution_label: "Solution",
        project_solution: "The ASOA 2.0 system automates monitoring through an IoT platform and a scientific algorithm.",
        project_impact_label: "Impact",
        project_impact: "Shortens conservation time by months and ensures the rescue of world underwater heritage.",
        project_docs: "📄 Documentation", project_site: "🌐 Website",
        project_details_title: "Research Project",
        back_to_project: "← Back to project",
        project_doc_h1: "Problems it Solves",
        project_doc_p1: "Our research began with great excitement and a visit to the archaeological museum...",
        project_doc_p2: "Our second visit to the museum coincided with the 50th anniversary of the discovery of the golden jewelry...",
        project_doc_p3: "Our next step was a meeting with experts from the Center for Underwater Archaeology...",
        project_doc_p4: "Before we reached the final solution, we went through a stage where we considered creating a protective hydrogel...",
        project_doc_p5: "Everything fell into place after an online meeting with a professional conservator...",
...
<span class="fn">print</span>(<span class="fn">win_tournament</span>())`,
    ...
    el: {
        ...
        gr_rule_1: "Το ρομπότ έχει πάντα μια αυστηρά καθορισμένη αρχική θέση.",
        gr_rule_2: "Ποτέ δεν ξεκινάμε το ρομπότ σε κλίση.",
        gr_rule_3: "Μηχανική αντοχή: Κάθε κατασκευή πρέπει να είναι όσο το δυνατόν πιο ισχυρή.",
        gr_rule_4: "Ο σχεδιασμός του ρομπότ πρέπει να είναι συμπαγής.",
        gr_rule_5: "Το υλικό και το λογισμικό πρέπει πάντα να αλληλοβοηθούνται.",
        gr_rule_6: "Πειραματική προσέγγιση: Κάθε ιδέα πρέπει να δοκιμάζεται.",
        gr_rule_7: "Αν κάτι πάει στραβά – φταίει πάντα το 'ρομπότ'.",
        gr_rule_8: "«Το μάτι του παρατηρητή»: Ένα τρίτο άτομο ελέγχει πάντα.",
        gr_rule_9: "Πριν από κάθε διαδρομή, τα λάστιχα καθαρίζονται.",
        gr_rule_10: "Μετά από κάθε επιστροφή στη βάση, ελέγξτε τους πείρους.",
        gr_rule_11: "Γρήγορη αλλαγή, ήρεμο μυαλό.",
        gr_rule_12: "Πάντα κοιτάμε τι κάνουν οι άλλοι.",
        gr_rule_13: "Όταν κάποιος λέει «ΣΤΟΠ», όλη η ομάδα σταματά.",
        gr_rule_14: "Κατανέμετε το βάρος συμμετρικά.",
        gr_rule_15: "Εύκολη πρόσβαση στην μπαταρία.",
        gr_rule_16: "Κάθε μπλοκ κώδικα πρέπει να έχει μια εξήγηση.",
        gr_rule_17: "Τα προβλήματα είναι βήματα προς την επιτυχία.",
        gr_rule_18: "Η καλύτερη λύση είναι η απλούστερη.",
        gr_rule_19: "Δεν επιτρέπονται χυμοί κοντά στον υπολογιστή.",
        gr_rule_20: "Το ρομπότ είναι μέλος της οικογένειας.",
        gr_rule_21: "Το γέλιο είναι η συντομότερη απόσταση μεταξύ ιδεών.",
        gr_rule_22: "Ο νόμος του δέκατου του χιλιοστού.",
        gr_rule_23: "Ο νόμος του Μόλις Ξεκίνησε.",
        gr_rule_24: "Αν δουλεύει – μην το αγγίζετε!",
        gr_rule_25: "Δημιουργική αταξία.",
        gr_rule_26: "Πάντα να έχετε εφεδρικά μέρη.",
        gr_rule_27: "Το φαινόμενο της μπλούζας MEHANO.",
        gr_rule_28: "Ανακαλύψτε τι δεν απαγορεύεται.",
        gr_rule_29: "Ο νόμος της καθαρής διαδρομής.",
        gr_rule_30: "Μετά τον διαγωνισμό – τρώμε ξανά."
